  ...
  computed: {
    ...
    navItems() {
      ...
      if (this.store.role === 'user') {
        return [
          { label: 'Bookings', to: '/traveler-bookings', icon: 'mdi-ticket-confirmation' },
          { label: 'Activities', to: '/traveler-activities', icon: 'mdi-hiking' },
        ];
      }
      if (this.store.role === 'operator') {
        return [
          { label: 'Arrangements', to: '/travel-arrangements', icon: 'mdi-briefcase' },
          { label: 'Activities', to: '/activities', icon: 'mdi-hiking' },
          { label: 'Activity Schedules', to: '/activity-schedules', icon: 'mdi-calendar-clock' },
          { label: 'Reviews', to: '/activity-reviews', icon: 'mdi-star' },
          { label: 'Customers', to: '/activity-customers', icon: 'mdi-account-group' },
          { label: 'Calendar', to: '/activity-calendar', icon: 'mdi-calendar' },
        ];
      }
